...
class DB3_GTR4_MIXRECAMB(IData):
    """
    ...
    def _parse(self, path):
        ...
        """
        raw_df = pd.read_excel(path, sheetname="DB3 GTR4", parse_cols='B,G,HL:IT', header=None, skiprows=3)     # using 'parse_cols' instead of 'usecols' because of older pandas version)
    ...
    def headdf(self):
        """ Prints the head of dataframe of the calling object of DB3_GTR4_MIXRECAMB class.
...
if __name__ == "__main__":
    ...
    GTR4MIXRECAMB = DB3_GTR4_MIXRECAMB()

    # Test 1
    GTR4MIXRECAMB._parse(reffilepath)
    GTR4MIXRECAMB.headdf()
    testfile = GTR4MIXRECAMB.export2Excel("test1DB3_MIXRECAMB.xlsx", export_folderpath)
