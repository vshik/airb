...
class DB4_GTR8_PP(IData):
    ...
    def _parse(self, path):
        ...
        # gtr data columns
        raw_df = pd.read_excel(path, sheetname="DB4 GTR8", parse_cols='JC:PA', header=None, skiprows=3)     # using 'parse_cols' instead of 'usecols' because of older pandas version)
        raw_df = raw_df.T
    ...
    def headdf(self):
        """ Prints the head of dataframe of the calling object of DB4_GTR8_PP class.
...
if __name__ == "__main__":
    ...
    # Test 1
    GTR8PP._parse(reffilepath)
    GTR8PP.headdf()
    testfile = GTR8PP.export2Excel("test1DB4_PP.xlsx", export_folderpath)
